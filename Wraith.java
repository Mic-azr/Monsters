public class Wraith extends Ghost{
    ...
    private String monsterDescription = "A subtype of Ghost characterized by its skeletal appearance and malicious nature. Wraiths are said to possess the power to kill, steal the soul of, or otherwise harm any person who encounters one.\n" +
    ...
    public void frighten() {
        System.out.println("[A skeletal hand emerges from beneath the Wraith's tattered, black robe.]\n" +
